...
*/
	...
	* Correcting subcounties not specified
	
	replace subcounty_id="010" if polling_station=="OBALANGA S/CTY HQTRS"
	replace subcounty="OBALANGA TOWN COUNCIL" if polling_station=="OBALANGA S/CTY HQTRS"
	
	replace subcounty_id="010" if polling_station=="OBALANGA BUS PARK OBIONG TREE"
	replace subcounty="OBALANGA TOWN COUNCIL" if polling_station=="OBALANGA BUS PARK OBIONG TREE"
	...
	*cross-checked
	...
	g region = ""
	replace region = "CENTRAL" if district=="BUVUMA"|district=="GOMBA"|district=="KALANGALA"|district=="KAMPALA" ///
			|district=="KALUNGU"|district=="KASSANDA"|district=="KAYUNGA"|district=="KIBOGA"|district=="KYANKWANZI"|district=="KYOTERA" ///
			|district=="LUWERO"|district=="LWENGO"|district=="LYANTONDE"|district=="MASAKA"|district=="MITYANA"|district=="MPIGI" ///
			|district=="MUBENDE"|district=="MUKONO"|district=="NAKASEKE"|district=="NAKASONGOLA"|district=="RAKAI"|district=="SSEMBABULE" ///
			|district=="WAKISO"|district=="MASAKA CITY"|district=="BUIKWE"|district=="BUKOMANSIMBI"|district=="BUTAMBALA"
			
	replace region = "EASTERN" if district=="AMURIA"|district=="BUDAKA"|district=="BUGIRI"|district=="BUGWERI" ///
			|district=="BUKEDEA"|district=="BUKWO"|district=="BULAMBULI"|district=="BUSIA"|district=="BUTALEJA"|district=="BUTEBO" ///
			|district=="BUYENDE"|district=="IGANGA"|district=="JINJA"|district=="KABERAMAIDO"|district=="KALAKI"|district=="KALIRO" ///
			|district=="KAMULI"|district=="KAPCHORWA"|district=="KAPELEBYONG"|district=="KATAKWI"|district=="KIBUKU"|district=="" ///
			|district=="KUMI"|district=="KWEEN"|district=="LUUKA"|district=="MANAFWA"|district=="MAYUGE"|district=="MBALE" ///
			|district=="NAMAYINGO"|district=="NAMISINDWA"|district=="NAMUTUMBA"|district=="NGORA"|district=="PALLISA"|district=="SERERE" ///
			|district=="SIRONKO"|district=="SOROTI"|district=="TORORO"|district=="JINJA CITY"|district=="MBALE CITY"|district=="SOROTI CITY" ///
			|district=="BUDUDA"
			
	replace region = "NORTHERN" if district=="ABIM"|district=="ADJUMANI"|district=="AGAGO"|district=="ALEBTONG" ///
			|district=="AMOLATAR"|district=="AMUDAT"|district=="AMURU"|district=="ARUA"|district=="ARUA CITY"|district=="DOKOLO" ///
			|district=="GULU"|district=="GULU CITY"|district=="KAABONG"|district=="KARENGA"|district=="KITGUM"|district=="KOBOKO" ///
			|district=="KOLE"|district=="KOTIDO"|district=="KWANIA"|district=="LAMWO"|district=="LIRA"|district=="MADI OKOLLO" ///
			|district=="MARACHA"|district=="MOROTO"|district=="MOYO"|district=="NABILATUK"|district=="NAKAPIRIPIRIT"| ///
			district=="NAPAK"|district=="NEBBI"|district=="NWOYA"|district=="LIRA CITY" ///
			|district=="OBONGI"|district=="OMORO"|district=="OTUKE"|district=="OYAM"|district=="PADER"|district=="PAKWACH" ///
			|district=="YUMBE"|district=="ZOMBO"||district=="APAC"|district=="TEREGO"
			
	replace region = "WESTERN" if district=="BUHWEJU"|district=="BULIISA"|district=="BUNDIBUGYO"|district=="BUNYANGABU" ///
			|district=="BUSHENYI"|district=="HOIMA"|district=="IBANDA"|district=="ISINGIRO"|district=="KABALE"|district=="KABAROLE" ///
			|district=="KAGADI"|district=="KAKUMIRO"|district=="KAMWENGE"|district=="KANUNGU"|district=="KASESE"|district=="KAZO" ///
			|district=="KIBAALE"|district=="KIKUUBE"|district=="KIRUHURA"|district=="KIRYANDONGO"|district=="KISORO"|district=="KITAGWENDA" ///
			|district=="KYENJOJO"|district=="MASINDI"|district=="MBARARA"|district=="MITOOMA"|district=="NTOROKO"|district=="NTUNGAMO" ///
			|district=="RUBANDA"|district=="RUBIRIZI"|district=="RUKIGA"|district=="RUKUNGIRI"|district=="RWAMPARA"|district=="SHEEMA" ///
			|district=="HOIMA CITY"|district=="FORT PORTAL CITY"|district=="MBARARA CITY"|district=="KYEGEGWA"
	...
	*check against official totals:
	/*
	preserve 
	collapse (sum) reg_voters (sum) amuriat (sum) kabuleta (sum) kalembe ///
	(sum) katumba (sum) kyagulanyi (sum) mao (sum) mayambala (sum) muntu ///
	(sum) mwesigye (sum) tumukunde (sum) museveni (sum) valid_votes (sum) ///
	invalid_votes (sum) total_votes
	restore
	*/
